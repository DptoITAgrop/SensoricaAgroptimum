...
export const farmsConfig: FarmConfig[] = [
  ...
  // ✅ ACTUALIZADO: VENTA LA CUESTA (según tus capturas)
  {
    id: 'Venta_la_Cuesta',
    ...
    sensors: [
      {
        id: 'sonda_1_ambiental_sector_2_carretera',
        name: 'Sonda 1 Ambiental (Sector 2 carretera)',
        tableName: 'sonda_1_ambiental__sector_2_carretera',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-24-02-23',
        coordinates: { lat: 39.28, lng: -2.09 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_1_suelo_sector_2_carretera',
        name: 'Sonda 1 Suelo (Sector 2 carretera)',
        tableName: 'sonda_1_suelo__sector_2_carretera',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-76-03',
        coordinates: { lat: 39.28, lng: -2.09 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_2_ambiental_sector_5_carretera',
        name: 'Sonda 2 Ambiental (Sector 5 carretera)',
        tableName: 'sonda_2_ambiental__sector_5_carretera',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-31-44-50',
        coordinates: { lat: 39.28, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_2_suelo_sector_5_carretera',
        name: 'Sonda 2 Suelo (Sector 5 carretera)',
        tableName: 'sonda_2_suelo__sector_5_carretera',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-91-10',
        coordinates: { lat: 39.28, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_3_ambiental_sector_22',
        name: 'Sonda 3 Ambiental (Sector 22)',
        tableName: 'sonda_3_ambiental__sector_22',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-24-02-03',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_3_suelo_sector_22',
        name: 'Sonda 3 Suelo (Sector 22)',
        tableName: 'sonda_3_suelo__sector_22',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-78-18',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_4_ambiental_sector_20',
        name: 'Sonda 4 Ambiental (Sector 20)',
        tableName: 'sonda_4_ambiental__sector_20',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-31-42-65',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_4_suelo_sector_20',
        name: 'Sonda 4 Suelo (Sector 20)',
        tableName: 'sonda_4_suelo__sector_20',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-91-51',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_5_ambiental_sector_1',
        name: 'Sonda 5 Ambiental (Sector 1)',
        tableName: 'sonda_5_ambiental__sector_1',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-24-06-95',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_5_suelo_sector_1',
        name: 'Sonda 5 Suelo (Sector 1)',
        tableName: 'sonda_5_suelo__sector_1',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-90-96',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_6_ambiente_sector_4',
        name: 'Sonda 6 Ambiente (Sector 4)',
        tableName: 'sonda_6_ambiente__sector_4',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-24-02-16',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_6_suelo_sector_4',
        name: 'Sonda 6 Suelo (Sector 4)',
        tableName: 'sonda_6_suelo__sector_4',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-55-10',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_7_ambiental_sector_11',
        name: 'Sonda 7 Ambiental (Sector 11)',
        tableName: 'sonda_7_ambiental__sector_11',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-31-45-74',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_7_suelo_sector_11',
        name: 'Sonda 7 Suelo (Sector 11)',
        tableName: 'sonda_7_suelo__sector_11',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-58-85',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_8_ambiental_sector_13',
        name: 'Sonda 8 Ambiental (Sector 13)',
        tableName: 'sonda_8_ambiental__sector_13',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-24-02-10',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_8_suelo_sector_13',
        name: 'Sonda 8 Suelo (Sector 13)',
        tableName: 'sonda_8_suelo__sector_13',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-85-34',
        coordinates: { lat: 39.29, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_9_ambiental_sector_16',
        name: 'Sonda 9 Ambiental (Sector 16)',
        tableName: 'sonda_9_ambiental__sector_16',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-31-44-36',
        coordinates: { lat: 39.28, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_9_suelo_sector_16',
        name: 'Sonda 9 Suelo (Sector 16)',
        tableName: 'sonda_9_suelo__sector_16',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-57-79',
        coordinates: { lat: 39.28, lng: -2.11 },
        farmId: 'Venta_la_Cuesta',
      },

      {
        id: 'sonda_10_ambiental_sector_9',
        name: 'Sonda 10 Ambiental (Sector 9)',
        tableName: 'sonda_10_ambiental__sector_9',
        model: 'NM-TH-EU',
        type: 'ambient',
        devEUI: '24-e1-24-13-6e-31-23-57',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
      {
        id: 'sonda_10_suelo_sector_9',
        name: 'Sonda 10 Suelo (Sector 9)',
        tableName: 'sonda_10_suelo__sector_9',
        model: 'NM-EM500-SMTC-EU',
        type: 'soil',
        devEUI: '24-e1-24-12-6e-39-97-85',
        coordinates: { lat: 39.29, lng: -2.1 },
        farmId: 'Venta_la_Cuesta',
      },
    ],
